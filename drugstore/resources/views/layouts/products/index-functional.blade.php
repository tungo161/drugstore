...
{{-- Đặt title cho page --}}
@section('title', 'Thực phẩm chức năng')

{{-- Đặt file css cho page --}}
@section('file', 'index-functional')

{{-- Đặt class cho body --}}
@section('page', 'index-functional')
    ...
    <div class='header-menu bg-color-5'>
        <div class='container align-items-center'>
            <nav aria-label="breadcrumb">
                ...
                text-black fs-7'
                            href='{{ url('products/index-functional') }}'>Thực phẩm chức năng</a></li>
                </ol>
            </nav>
        </div>
    </div>
    <main class="main">
        <div class="py-xl-5 my-4">
            <div class="py-3 py-xl-2 container">
                <h2 class='under-line between-line fw-4 color-1 m-0 position-relative text-center'>Thực phẩm chức năng</h2>
                <div class="pt-3 mt-4">
                    <div class="mb-4">
                        ...
                        <div class="pt-2 mb-4">
                            ...
                            <span class="fs-4 fw-4 fw-4">{{ $productFunctional->total() }} kết quả tìm kiếm cho: </span>
                            ...
                            <div class="col mb-xl-4">
                                <div class='rounded-10 shadow-sm h-100'>
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        <div class="">
                                            <a class="text-decoration-none" href="{{ url("products/{$Functional->id}") }}">
                                                <div
                                            ...
                                            <div class='p-3'>
                                                ...
                                                <div class='mb-2 d-flex align-items-baseline'>
                                                    <span class='fs-7 color-7 m-0'>Số lượng còn lại:
                                                        <span class='text-black fw-4'>{{ $Functional->quantity }}</span>
                                                    </span>
                                                </div>
                                        ...
                                        <div class="d-flex justify-content-center w-100 pb-3">
                                            ...
                                            @else
                                                <a class="w-50" href="{{ route('addcart', [$Functional->id]) }}" type="submit">
            ...
            <div class="d-flex justify-content-center pt-3">
                {!! $productFunctional->onEachSide(1)->links() !!}
            </div>
