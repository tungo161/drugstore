<!-- offcanvas -->
<div class="offcanvas offcanvas-start sidebar-nav bg-dark" tabindex="-1" id="sidebar" style='width:270px'>
    <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
            <ul class="navbar-nav">
                ...
                <li>
                    <a href="{{ url('quan-ly-bai-viet') }}" class="nav-link px-3">
                        <span class="me-2"><i class="bi bi-table"></i></span>
                ...
                <li>
                    ...
                    <a class="nav-link px-3" href="#!"
                        onclick="document.getElementById('logout-form').submit()">Đăng xuất</a>
